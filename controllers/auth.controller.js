 ...
 * @param {eStatusCode} eStatusCode -> Response status code
 * @param {req} Request
 * @param {res} Response
 */
const createSendToken = (user, eStatusCode, req, res) => {
...
const login = catchAsync(async (req, res, next) => {
  ...
  if (!email || !password) {
    return next(
      new AppError('Please provide email and password', eStatusCode.BAD_REQUEST)
    );
  }
